...
arguments. Based on the types, the right overload gets picked by the compiler:
...
/*:
This is because the static type of the `view` variable is `UIView`; it's
irrelevant that the dynamic type `UILabel` would result in a different overload
at runtime.
