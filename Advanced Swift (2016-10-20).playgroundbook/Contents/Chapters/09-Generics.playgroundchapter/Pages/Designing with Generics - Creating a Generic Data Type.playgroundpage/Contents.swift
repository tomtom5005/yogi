...
/*:
The previous top-level functions to load a specific resource now become values
of the `Resource` struct. This makes it very easy to add new resources without
having to create new functions:
