...
specialization* to remove this overhead. Generic specialization means that the
...
for `Int`, removing all the overhead. So the specialized version of `min<T>` for
...
/*:
This not only eliminates the cost of the virtual dispatch, but it also enables
further optimizations such as inlining, for which the indirection would
