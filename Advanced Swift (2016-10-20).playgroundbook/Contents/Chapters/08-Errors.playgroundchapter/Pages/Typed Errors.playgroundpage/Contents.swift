...
concrete errors a function can throw. If we care about this, we can come up with
a slightly altered `Result` type, which has an additional generic parameter for
the error type:
