...
two stacks (two regular Swift arrays). As elements are enqueued, they're pushed
onto the "right" stack. Then, when elements are dequeued, they're popped off the
