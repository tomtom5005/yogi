...
Some operations have additional requirements, though, and it would be nice to
...
Let's discuss them one by one. But before we do that, we need to take a look at
what it means to have forward-only index traversal.
