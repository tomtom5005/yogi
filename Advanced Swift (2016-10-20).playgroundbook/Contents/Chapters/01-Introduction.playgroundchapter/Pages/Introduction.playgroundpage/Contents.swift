...
conventions and adopting others. Over the past two years, Swift has evolved at a
high pace, and it has become clearer what idiomatic Swift is.
...
or F\#. And the `@objc` keyword allows you to use selectors and runtime dynamism
in ways you would in Objective-C.
