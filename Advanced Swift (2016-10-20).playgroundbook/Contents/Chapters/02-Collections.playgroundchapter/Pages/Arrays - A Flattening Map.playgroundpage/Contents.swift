...
The implementation for `flatMap` is almost identical to `map`, except it takes a
function argument that returns an array. It uses `append(contentsOf:)` instead
of `append(_:)` to flatten the results when appending:
