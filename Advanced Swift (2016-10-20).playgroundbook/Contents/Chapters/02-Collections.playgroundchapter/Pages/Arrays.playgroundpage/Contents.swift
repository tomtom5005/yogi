...
In Swift, instead of needing two types, there's just one, and mutability is
defined by declaring with `var` instead of `let`. But there's no reference
sharing — when you declare a second array with `let`, you're guaranteed it'll
never change.
