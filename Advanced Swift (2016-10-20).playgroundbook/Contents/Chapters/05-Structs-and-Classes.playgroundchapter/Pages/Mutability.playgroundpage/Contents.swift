...
in order to write safe, maintainable code. Luckily, Swift allows us to write
safe code while preserving an intuitive mutable coding style at the same time.
