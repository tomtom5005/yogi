...
addresses. All of these types are implemented using objects, and all of them are
reference types.
...
arrays that perform "smart" copy-on-write — complement each other. We'll look at
how to implement your own copy-on-write mechanism shortly.

If your struct is composed out of other structs, the compiler can enforce
